...
export default function SchedulingMedicineScreen() {
  ...
  const handleEditMedicine = (medicine) => {
    ...
    navigation.navigate('AddingMedicine', {
    ...
    return (
      <View style={styles.sectionContainer}>
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('AddingMedicine', { timeOfDay })}>
